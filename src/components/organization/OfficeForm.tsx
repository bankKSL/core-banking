        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
                ...
                <Select
                    ...
                    onValueChange={(v) =>
                        setValue("parentId", v ? Number(v) : undefined, { shouldValidate: true })
                    }
                >
            ...
            <div>
                ...
                />
                {errors.openingDate && (
                    <p className="mt-1 text-xs text-red-500">{errors.openingDate.message}</p>
                )}
            </div>
            ...
            <div>
                ...
                />
                {errors.externalId && (
                    <p className="mt-1 text-xs text-red-500">{errors.externalId.message}</p>
                )}
            </div>
