...
const quickActions = [
  {
    ...
    description: "Configure business step order for COB jobs",
    path: "/cob/steps",
    icon: ListOrdered,
    color: "text-blue-600",
  },
  {
    label: "Catch-Up",
    description: "Trigger and monitor COB catch-up processing",
    path: "/cob/catch-up",
    icon: Play,
  ...
  {
    label: "Locked Loans",
    description: "View loans locked during COB processing",
