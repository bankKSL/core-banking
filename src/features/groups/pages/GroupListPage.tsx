    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3 rounded-lg border border-red-200 bg-red-50 p-4 text-red-700 dark:border-red-800 dark:bg-red-950 dark:text-red-400">
          ...
          <span className="text-sm">{t("Failed to load groups.")} {error?.message ?? t("Please try again.")}</span>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="officeName:asc">{t("Office (A → Z)")}</SelectItem>
                <SelectItem value="officeName:desc">{t("Office (Z → A)")}</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </CardHeader>
