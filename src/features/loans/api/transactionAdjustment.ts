...
/**
 * Adjustment commands supported by server per doc §7.15:
...
export type AdjustmentCommand =
  "chargeback" | "capitalizedIncomeAdjustment" | "buyDownFeeAdjustment" | "interest-refund";
...
export const modifyTransaction = (loanId: number, transactionId: number, payload: AdjustmentPayload) =>
