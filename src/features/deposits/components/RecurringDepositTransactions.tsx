...
import { useRecurringDepositTransactions, useUndoRecurringDepositTransaction } from "../hooks/useRecurringDepositTransactions";
import type { RecurringDepositTransaction } from "../api/deposit";
...
interface RecurringDepositTransactionsProps {
  accountId: number;
}
...
export default RecurringDepositTransactions;
