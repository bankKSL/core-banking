            ...
            <PageHeader
                ...
                actions={
                    <div className="flex items-center gap-2">
                        ...
                        <ClientCommands clientId={client.id} status={status} displayName={displayName} onSuccess={() => refetch()} />
                        {isPending && (
                            <Button variant="outline" size="sm" onClick={() => setShowActivateConfirm(true)} className="text-emerald-600 border-emerald-200 hover:bg-emerald-50">
                                            ...
                                            {accounts?.loanAccounts?.map((loan: ClientLoanAccount) => (
                                                ...
                                                >
                                                    <div className="flex items-center justify-between mb-1">
                                                        ...
                                                        <Badge variant={loan.status.active ? "success" : loan.status.closed ? "default" : "info"} size="sm">
                                            ...
                                            {accounts?.savingsAccounts?.map((sav: ClientSavingsAccount) => (
                                                ...
                                                >
                                                    <div className="flex items-center justify-between mb-1">
                                                        ...
                                                        <Badge variant={sav.status.active ? "success" : sav.status.closed ? "default" : "warning"} size="sm">
