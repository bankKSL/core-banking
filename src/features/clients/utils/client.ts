...
/**
 * Normalize a date value from service to a Date object.
 * Handles:
 *  - string in "yyyy-MM-dd" format
 *  - string in "yyyy-MM-dd" format
 *  - number array [year, month, day] (service array format)
...
/** Format date for display — handles string or service number[] */
...
/** Calculate age — handles string or service number[] */
