...
export async function fetchClientDocuments(
    ...
    const { data } = await client.get<ClientDocument[]>(
...
export async function downloadClientDocument(
    ...
    const { data } = await client.get<Blob>(
        `/clients/${clientId}/documents/${documentId}/attachment`,
        { responseType: "blob" },
    );
    return data;
}
...
export async function createClientDocument(
    ...
    const { data } = await client.post<ClientDocumentCommandResponse>(
        `/clients/${clientId}/documents`,
        formData,
        {
...
export async function deleteClientDocument(
    ...
    const { data } = await client.delete<ClientDocumentCommandResponse>(
        `/clients/${clientId}/documents/${documentId}`,
    );
    return data;
}
