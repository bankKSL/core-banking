                    ...
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        ...
                        <Card className="col-span-full">
                            ...
                            <CardContent className="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                    <span className="text-gray-500">Compounding:</span> <span className="font-medium">{fd.interestCompoundingPeriodType?.value ?? "\u2014"}</span>
                                </div>
                                <div>
                                    <span className="text-gray-500">Posting:</span> <span className="font-medium">{fd.interestPostingPeriodType?.value ?? "\u2014"}</span>
                                </div>
                                <div>
                                    <span className="text-gray-500">Calculation:</span> <span className="font-medium">{fd.interestCalculationType?.value ?? "\u2014"}</span>
                                </div>
                                <div>
                                    <span className="text-gray-500">Days/Year:</span> <span className="font-medium">{fd.interestCalculationDaysInYearType?.value ?? "\u2014"}</span>
                                </div>
                            </CardContent>
                        </Card>
                    </div>
