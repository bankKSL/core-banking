          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-4 py-4 max-h-[65vh] overflow-y-auto">
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={(v) => setField("fundId", Number(v))}
              >
                <SelectTrigger>
            ...
            <div className="space-y-1.5">
              ...
              <Select
                value={String(form.repaymentFrequencyType ?? 2)}
                onValueChange={(v) => setField("repaymentFrequencyType", Number(v))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-1.5">
              ...
              <Select
                value={String(form.amortizationType ?? 1)}
                onValueChange={(v) => setField("amortizationType", Number(v))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-1.5">
              ...
              <Select
                value={String(form.interestCalculationPeriodType ?? 0)}
                onValueChange={(v) => setField("interestCalculationPeriodType", Number(v))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-1.5">
              ...
              {errors.transactionProcessingStrategyCode && (
                <p className="text-xs text-red-500">{errors.transactionProcessingStrategyCode}</p>
              )}
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Select
                value={String(form.daysInYearType ?? 1)}
                onValueChange={(v) => setField("daysInYearType", Number(v))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
