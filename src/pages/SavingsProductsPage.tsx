...
const SavingsProductsPage: React.FC = () => {
    ...
    const handleSave = async () => {
        ...
        if (form.nominalAnnualInterestRate == null || form.nominalAnnualInterestRate < 0) e.nominalAnnualInterestRate = "Interest rate is required";
        setErrors(e);
    ...
    const columns: ColumnDef<SavingsProduct>[] = [
        ...
        { key: "nominalAnnualInterestRate", header: "Rate", cell: (r) => <span className="font-mono">{r.nominalAnnualInterestRate ?? 0}%</span> },
        {
            key: "actions",
            header: "",
            cell: (r) => (
