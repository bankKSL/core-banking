...
const ConditionsPage: React.FC = () => {
    ...
    const ruleColumns: ColumnDef<FlatRule>[] = [
        ...
        },
        {
            key: "operator",
            header: "Operator",
            cell: (row) => <code className="text-xs bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded font-mono">{row.operator}</code>,
        },
        {
            key: "value",
            header: "Value",
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
                <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between mb-4">
                    ...
                    <div className="relative w-full sm:w-72">
                        ...
                        <Input placeholder="Search rules..." value={search} onChange={(e) => setSearch(e.target.value)} className="pl-10" />
                    </div>
                </div>
                                                                ...
                                                                <tr key={rule.id} className="border-t border-gray-100 dark:border-gray-700">
                                                                    ...
                                                                    <td className="px-4 py-2">
                                                                        {rule.logicalOperator ? (
                                                                            <Badge
                                                                                variant={
                                                                                    rule.logicalOperator === "AND" ? "info" : "warning"
                                                                                }
                                                                                size="sm"
                                                                            >
                                                                                {rule.logicalOperator}
